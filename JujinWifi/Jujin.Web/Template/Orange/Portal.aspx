...
<body>
    <div class="pw">
		...
		<script type="text/javascript" src="/template/orange/js/touchScroll.js"></script>
		<script type="text/javascript" src="/template/orange/js/touchslider.dev.js"></script>
		<script type="text/javascript" src="/template/orange/js/run.js"></script>
		<!--演示内容结束-->
        <div class="main-con">
        ...
        <div class="body_footer">
            <ul>
                <li><a href="Portal.aspx?merchant_id=<%:merchant.id %>">
                    <dl>
                        <dt>
                            <img src="/template/orange/images/icon_1.png"></dt>
                        <dd>
                            返回首页</dd>
                    </dl>
                </a></li>
                <li><a href="tel:<%:merchant.contact_phone %>">
                    <dl>
                        <dt>
                            <img src="/template/orange/images/icon_4.png"></dt>
                        <dd>
                            打电话</dd>
                    </dl>
                </a></li>
                <li><a href="map.aspx?merchant_id=<%:merchant.id %>">
                    <dl>
                        <dt>
                            <img src="/template/orange/images/icon_3.png"></dt>
                        <dd>
                            地图</dd>
                    </dl>
                </a></li>
                <li><a href="/hao">
                    <dl>
                        <dt>
                            <img src="/template/orange/images/icon_5.png"></dt>
                        <dd>
                            网址导航</dd>
                    </dl>
                </a></li>
