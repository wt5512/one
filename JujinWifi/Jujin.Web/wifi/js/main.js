...
$(function () {
    ...
    $('.jujinwifi_nav ul li').click(function () {
    ...
    $(window).scroll(function () {//定义页面滚动函数
        ...
        if (myScrollTop >= 1660 && myScrollTop < 2364) {
            ...
            $('.jujinwifi_nav').fadeOut(500);
        }
        $('.jujinwifi_nav ul li').eq(numLi).addClass('current').siblings().removeClass('current'); //滚动内容块区间改变对应浮窗菜单样式
    })
